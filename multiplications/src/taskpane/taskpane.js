...
async function insertParagraph() {
  await Word.run(async (context) => {
    let text = "Office has several versions, including Office 2016, Microsoft 365 subscription, and Office on the web."
    const docBody = context.document.body;
    docBody.insertParagraph(text, Word.InsertLocation.start);
    await context.sync();
  });
}
